function [acc,confusionMatrix] = EvalTeboulGT(fold,nImages)
    ...
    dataLocation = '/usr/data/amartino/Facades/ECPdatabase/cvpr2010/labels/';
    ...
    for imageNr=1:nImages
        fprintf('.');
        imageName = [dataLocation imageNames{imageNr} '.png' ];
