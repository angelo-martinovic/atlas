...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb='\n\x10\x64\x65tections.proto\x12\x0f\x62iclop_protobuf\"\x1f\n\x07Point2d\x12\t\n\x01x\x18\x01 \x02(\x05\x12\t\n\x01y\x18\x02 \x02(\x05\"a\n\x03\x42ox\x12,\n\nmin_corner\x18\x01 \x02(\x0b\x32\x18.biclop_protobuf.Point2d\x12,\n\nmax_corner\x18\x02 \x02(\x0b\x32\x18.biclop_protobuf.Point2d\"\xfb\x01\n\tDetection\x12*\n\x0c\x62ounding_box\x18\x01 \x02(\x0b\x32\x14.biclop_protobuf.Box\x12>\n\x0cobject_class\x18\x02 \x02(\x0e\x32(.biclop_protobuf.Detection.ObjectClasses\x12\r\n\x05score\x18\x03 \x01(\x02\"s\n\rObjectClasses\x12\x07\n\x03\x43\x61r\x10\x02\x12\x0e\n\nPedestrian\x10\x03\x12\x08\n\x04\x42ike\x10\x05\x12\r\n\tMotorbike\x10\x06\x12\x07\n\x03\x42us\x10\x07\x12\x08\n\x04Tram\x10\x08\x12\x10\n\x0cStaticObject\x10\x04\x12\x0b\n\x07Unknown\x10\x00\"P\n\nDetections\x12\x12\n\nimage_name\x18\x01 \x01(\t\x12.\n\ndetections\x18\x02 \x03(\x0b\x32\x1a.biclop_protobuf.Detection')



_DETECTION_OBJECTCLASSES = _descriptor.EnumDescriptor(
  name='ObjectClasses',
  full_name='biclop_protobuf.Detection.ObjectClasses',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_POINT2D = _descriptor.Descriptor(
  name='Point2d',
  full_name='biclop_protobuf.Point2d',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='biclop_protobuf.Point2d.x', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='y', full_name='biclop_protobuf.Point2d.y', index=1,
...
_BOX = _descriptor.Descriptor(
  name='Box',
  full_name='biclop_protobuf.Box',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_corner', full_name='biclop_protobuf.Box.min_corner', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_corner', full_name='biclop_protobuf.Box.max_corner', index=1,
...
_DETECTION = _descriptor.Descriptor(
  name='Detection',
  full_name='biclop_protobuf.Detection',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bounding_box', full_name='biclop_protobuf.Detection.bounding_box', index=0,
      number=1, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='object_class', full_name='biclop_protobuf.Detection.object_class', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='score', full_name='biclop_protobuf.Detection.score', index=2,
...
_DETECTIONS = _descriptor.Descriptor(
  name='Detections',
  full_name='biclop_protobuf.Detections',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='image_name', full_name='biclop_protobuf.Detections.image_name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='detections', full_name='biclop_protobuf.Detections.detections', index=1,
...
class Point2d(_message.Message):
  ...
  # @@protoc_insertion_point(class_scope:biclop_protobuf.Point2d)

class Box(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _BOX

  # @@protoc_insertion_point(class_scope:biclop_protobuf.Box)

class Detection(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _DETECTION

  # @@protoc_insertion_point(class_scope:biclop_protobuf.Detection)

class Detections(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _DETECTIONS

  # @@protoc_insertion_point(class_scope:biclop_protobuf.Detections)
